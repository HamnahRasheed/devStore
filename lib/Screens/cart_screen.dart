          ...
          title: Column(
            children: [
              Row(
                ...
                children: const [
                  Text('Dev', style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold)),
                  Text('Store', style: TextStyle(color: Colors.green, fontSize: 24, fontWeight: FontWeight.bold)),
                ],
              ),
          ...
          content: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Items Purchased:', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                      ...
                      return Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text('\$${itemTotal.toStringAsFixed(2)}', style: const TextStyle(color: Colors.green, fontSize: 14)),
                          ],
                        ),
                      );
                    },
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text('\$${total.toStringAsFixed(2)}', style: const TextStyle(color: Colors.green, fontSize: 18, fontWeight: FontWeight.bold)),
                  ],
                ),
              ],
            ),
